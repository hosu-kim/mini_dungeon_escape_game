...
/*   Updated: 2025/04/21 20:19:26 by hoskim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->img_player)
		mlx_destroy_image(game->graphics, game->img_player);
	if (game->img_wall)
		mlx_destroy_image(game->graphics, game->img_wall);
	if (game->img_collectible)
		mlx_destroy_image(game->graphics, game->img_collectible);
	if (game->img_exit)
		mlx_destroy_image(game->graphics, game->img_exit);
	if (game->img_floor)
		mlx_destroy_image(game->graphics, game->img_floor);
}
...
void	exit_game(t_game_resources *game)
{
	...
	free_images(game);
	if (game->win)
		mlx_destroy_window(game->graphics, game->win);
	if (game->map)
	{
